...
All Rights Reserved. */
import { l, k as _ } from './chunks/icons/Add.js';
var v = /["&<]/;
function p(r) {
  if (r.length === 0 || v.test(r) === !1) return r;
...
var y = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,
  d = 0,
  x = Array.isArray;
function b(r, t, e, a, n, i) {
  t || (t = {});
  var s,
    o,
    f = t;
  if ('ref' in f) for (o in ((f = {}), t)) o == 'ref' ? (s = t[o]) : (f[o] = t[o]);
  var u = {
    type: r,
    props: f,
    key: e,
  ...
  if (typeof r == 'function' && (s = r.defaultProps)) for (o in s) f[o] === void 0 && (f[o] = s[o]);
...
function m(r, t) {
  ...
  if (r === 'ref' || r === 'key') return '';
  if (r === 'style' && typeof t == 'object') {
    var a = '';
    for (var n in t) {
      var i = t[n];
      if (i != null && i !== '') {
        var s = n[0] == '-' ? n : c[n] || (c[n] = n.replace(g, '-$&').toLowerCase()),
          o = ';';
        (typeof i != 'number' || s.startsWith('--') || y.test(s) || (o = 'px;'),
          (a = a + s + ':' + i + o));
      }
    }
    return r + '="' + a + '"';
...
function j(r) {
  ...
  if (typeof r == 'object') {
    ...
    if (x(r)) {
      for (var t = 0; t < r.length; t++) r[t] = j(r[t]);
      return r;
    }
  }
  return p('' + r);
