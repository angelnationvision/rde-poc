...
const n = a =>
  t(
    ...
    t(
      ...
      t(
        'g',
        { id: 'Bulk_icon', 'data-name': 'Bulk icon', transform: 'translate(-141 -10)' },
        t(
          'g',
          {
            id: 'Rectangle_215979',
          ...
          t('rect', { width: 12, height: 12, stroke: 'none' }),
          t('rect', {
        ...
        t('path', {
          ...
          d: 'M147.527,18.7h6',
          transform: 'translate(-0.527 0.305)',
          fill: 'none',
          stroke: 'currentColor',
        }),
        t(
