...
All Rights Reserved. */
import { jsx as o } from '../preact-jsx-runtime.js';
import { G as w, T as c, k as x, h as y } from './icons/Add.js';
import { IntlProvider as f } from '../i18n.js';
import { d as n } from './cjs.js';
import { R as T, g as S, c as I } from './vcomponent.js';
const P = {
    ExampleComponentName: { item: { label: 'string' } },
    Pagination: {
      backwardButton: { ariaLabel: 'Go to previous page' },
      forwardButton: { ariaLabel: 'Go to next page' },
    },
    Incrementer: {
    ...
    ProgressSpinner: {
      updating: { label: 'Item is updating' },
      updatingChildren: { label: 'Items are updating' },
    },
  ...
  k = e => n(d.default, d[e] || {}),
  v = w({ locale: 'en-US' }),
  C = ({ lang: e = 'en_US', langDefinitions: t = {}, children: a }) => {
    const l = c(() => {
        const i = n(t.default, t[e] ?? {});
        return n(k(e), i);
      }, [e, t]),
      s = e.replace('_', '-');
    return o(v.Provider, {
      value: { locale: s },
      children: o(f, { definition: l, children: o(x, { children: a }) }),
    });
  },
  B = new T(o(C, {})),
  D = ({ className: e, src: t, params: a, loading: l = 'lazy', srcSet: s, onLoad: i, ...u }) => {
    const [m, p] = y(!1),
      b = c(() => {
        if (s) return s;
        if (!(!t || !a)) return S(t, { ...a });
    ...
    return o('img', {
      ...u,
      className: I(['dropin-image', ['dropin-image--loaded', m], e]),
      loading: l,
      onLoad: h,
      src: t,
      srcSet: b,
...
export { D as I, v as U, C as a, B as p };
