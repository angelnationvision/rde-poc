...
All Rights Reserved. */
import { jsx as r, jsxs as c, Fragment as N } from '@dropins/tools/preact-jsx-runtime.js';
import { useMemo as V } from '@dropins/tools/preact-hooks.js';
import { classes as K, Slot as S } from '@dropins/tools/lib.js';
import {
  IllustratedMessage as n1,
  Icon as A,
  Card as O,
  ContentGrid as t1,
  Image as a1,
...
import * as l from '@dropins/tools/preact-compat.js';
import { useMemo as L1 } from '@dropins/tools/preact-compat.js';
import './ShippingStatusCard.js';
import { f as U } from './returnOrdersHelper.js';
import '@dropins/tools/preact.js';
import '@dropins/tools/event-bus.js';
import { C as I } from './OrderLoaders.js';
import { c as s1 } from './capitalizeFirst.js';
import { Text as J } from '@dropins/tools/i18n.js';
const W = L =>
    l.createElement(
      'svg',
      {
  ...
  X = ({ typeList: L, isEmpty: C, minifiedView: f, message: M }) => {
    const n = L1(() => {
      switch (L) {
        case 'orders':
          return {
    ...
    return !C || !L || !n.text
      ? null
      : r(n1, {
          className: K(['order-empty-list', n.className, f ? 'order-empty-list--minified' : '']),
          message: n.text,
          icon: r(A, { source: n.icon }),
  ...
  f1 = ({
    placeholderImage: L,
    minifiedViewKey: C,
    withReturnNumber: f = !1,
    withOrderNumber: M = !1,
    slots: n,
    pageInfo: s,
    withReturnsListButton: B = !0,
    isMobile: $ = !1,
    returnsInMinifiedView: R = 1,
    translations: a = {},
    orderReturns: i = [],
    minifiedView: o = !1,
    withHeader: v = !0,
    withThumbnails: k = !0,
    selectedPage: z = 1,
    handleSetSelectPage: F,
    routeReturnDetails: d,
    routeOrderDetails: b,
    routeTracking: x,
    routeReturnsList: y,
    routeProductDetails: m,
    loading: H,
  }) => {
    const j = o ? R : i.length,
      G = m != null && m() ? 'a' : 'span',
      E = V(
        () =>
          i.slice(0, j).map((e, e1) => {
            var P, T;
            const w = ((e == null ? void 0 : e.items) ?? []).reduce(
              (t, u) => (u.requestQuantity ?? 0) + t,
              0
            );
            return r(
              O,
              {
                ...
                children: c('div', {
                  className: 'order-returns-list-content__cards-grid',
                  children: [
                    c('div', {
                      className: 'order-returns-list-content__descriptions',
                      children: [
                        r('p', {
                          className: 'order-returns-list-content__return-status',
                          children: U(e.returnStatus)
                            ? r(J, {
                                id: `Order.Returns.${C}.returnsList.returnStatus.${U(e.returnStatus)}`,
                              })
                            : r('span', { children: s1(e.returnStatus) }),
                        }),
                        f
                          ? c('p', {
                              children: [
                        ...
                        M
                              ...
                              children: [
                                ...
                                r('a', {
                                  href:
                                    (b == null
                                      ? void 0
                                      : b({ orderNumber: e.orderNumber, token: e.token })) ?? '#',
                                  rel: 'noreferrer',
                          ...
                          : null,
                        (P = e == null ? void 0 : e.tracking) == null
                          ? void 0
                          : P.map((t, u) => {
                              var _, g;
                              const h = {
                                  title: '',
                                  number: (t == null ? void 0 : t.trackingNumber) ?? '',
                                  carrier:
                                    ((_ = t == null ? void 0 : t.carrier) == null
                                      ? void 0
                                      : _.label) ?? '',
                                },
                                Z = x == null ? void 0 : x(h),
                              ...
                              return c(
                                'p',
                                {
                                  children: [
                                    `${a.carrier} `,
                                    `${(g = h.carrier) == null ? void 0 : g.toLocaleUpperCase()} | `,
                                    Z
                                      ? r('a', {
                                          href: Z,
                                          target: '_blank',
                        ...
                        n != null && n.ReturnItemsDetails
                          ? r(S, {
                              'data-testid': 'returnItemsDetails',
                              name: 'ReturnItemsDetails',
                              slot: n == null ? void 0 : n.ReturnItemsDetails,
                              context: { items: e.items },
                            })
                          : null,
                        !(n != null && n.ReturnItemsDetails) && e.items.length
                          ? c('p', {
                              children: [
                                w,
                                ' ',
                                r(J, {
                                  id: `Order.Returns.${C}.returnsList.itemText`,
                                  plural: w,
                                  fields: { count: w },
                                }),
                              ],
                    ...
                    k
                      ? r(t1, {
                          maxColumns: $ ? 3 : 9,
                          emptyGridContent: r(N, {}),
                          className: K([
                            'order-returns-list-content__images',
                            ['order-returns-list-content__images-3', $],
                          ]),
                          children:
                            (T = e == null ? void 0 : e.items) == null
                              ? void 0
                              : T.map((t, u) => {
                                  var g, q;
                                  const h = `key_${u}_${t.uid}`,
                                    Z =
                                      ((g = t == null ? void 0 : t.product) == null
                                        ? void 0
                                        : g.name) ?? '',
                                    p =
                                      ((q = t == null ? void 0 : t.thumbnail) == null
                                        ? void 0
                                        : q.url) ??
                                      L ??
                                      '',
                                  ...
                                  return r(
                                    ...
                                    {
                                      'data-testid': h,
                                      href: (m == null ? void 0 : m(t)) ?? '#',
                                      children: r(S, {
                                        slotTag: 'span',
                                        contentTag: 'span',
                                        name: 'ReturnListImage',
                                        slot: n == null ? void 0 : n.ReturnListImage,
                                        context: { data: t, defaultImageProps: _ },
                                        children: r(a1, { ..._ }),
                                      }),
                                    },
                                    h
                ...
                : c(N, {
                    children: [
                      ...
                      r(X, {
                        ...
                        typeList: 'orders',
                        isEmpty: !i.length,
                        message: a.emptyOrdersListMessage,
                      }),
                      B
                        ? r('a', {
                            className: 'order-returns-list-content__actions',
                            ...
                            children: r(O, {
                              ...
                              children: c('div', {
                                className: 'order-returns-list-content__card-wrapper',
                                children: [
                                  r('p', { children: a.viewAllOrdersButton }),
                                  r(A, { source: W, ...Y }),
                                ],
                              }),
                            }),
      ...
      r1 = V(
        ...
        [E, o, i, a, s == null ? void 0 : s.totalPages, z, F, H, v]
      );
    return r('div', { className: 'order-returns-list-content', children: o ? D : r1 });
  };
export { f1 as R };
