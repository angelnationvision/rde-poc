...
export declare const transformConfigurableOptions: (
  item: OrderItemProps
) => Record<string, string> | undefined;
export declare const transformBundleOptions: (data: any) => {
  [key: string]: any;
} | null;
export declare const transformLinks: (
  links: {
    title: string;
  }[]
) => {
...
export declare const transformOrderData: (
  orderData: OrderProps,
  returnRef?: string
) => OrderDataModel;
export declare const transformOrderDetails: <T extends 'orderData'>(
  queryType: QueryType,
