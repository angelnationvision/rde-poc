...
export interface ReturnsListProps {
  ...
  routeOrderDetails?: ({ token, orderNumber }: { token: string; orderNumber: string }) => string;
...
export interface ReturnsListContentProps
  extends Omit<ReturnsListProps, 'className' | 'returnPageSize'> {
...
export interface OrderReturnsProps {
  ...
  routeReturnDetails?: ({ token, orderNumber }: { token: string; orderNumber: string }) => string;
