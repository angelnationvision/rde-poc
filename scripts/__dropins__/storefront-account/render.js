  ...
  try {
    if (typeof document < 'u') {
      const a = document.createElement('style'),
        o = r.styleId;
      for (const t in r.attributes) a.setAttribute(t, r.attributes[t]);
      (a.setAttribute('data-dropin', o), a.appendChild(document.createTextNode(e)));
      const c = document.querySelector('style[data-dropin="sdk"]');
      if (c) c.after(a);
      else {
        const t = document.querySelector('link[rel="stylesheet"], style');
        t ? t.before(a) : document.head.append(a);
      }
    }
  } catch (a) {
...
const u = {
    minifiedView: {
      CustomerInformation: {
        ...
        changePassword: {
          ...
          currentPassword: { placeholder: 'Password', floatingLabel: 'Password' },
          newPassword: { placeholder: 'New Password', floatingLabel: 'New Password' },
          confirmPassword: {
        ...
        editCustomerInformation: {
          ...
          passwordField: { placeholder: 'Password', floatingLabel: 'Password' },
        },
      },
      Addresses: {
      ...
      EmptyList: {
        Addresses: { message: 'No saved addresses' },
        OrdersList: { message: 'No orders' },
      },
    },
    fullSizeView: {
      Addresses: {
  ...
  f = ({ children: a }) => {
    ...
    return (
      ...
      r(l, { lang: s, langDefinitions: p, children: a })
    );
  },
  A = new i(r(f, {}));
export { A as render };
