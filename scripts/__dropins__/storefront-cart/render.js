  ...
  try {
    if (typeof document < 'u') {
      const t = document.createElement('style'),
        o = r.styleId;
      for (const a in r.attributes) t.setAttribute(a, r.attributes[a]);
      (t.setAttribute('data-dropin', o), t.appendChild(document.createTextNode(e)));
      const i = document.querySelector('style[data-dropin="sdk"]');
      if (i) i.after(t);
      else {
        const a = document.querySelector('link[rel="stylesheet"], style');
        a ? a.before(t) : document.head.append(t);
      }
    }
  } catch (t) {
...
const h = {
    ...
    PriceSummary: {
      ...
      giftCard: {
        ...
        title: 'Gift Card',
        errors: { empty: 'Please enter a gift card code.' },
        appliedGiftCards: {
    ...
    GiftOptions: {
      formText: { requiredFieldError: 'This field is required' },
      modal: {
      ...
      order: {
        ...
        printedCardIncluded: { title: 'Include printed card', subtitle: '' },
        giftOptionsWrap: { title: 'Gift wrap this order', subtitle: 'Wrapping option:' },
        formContent: {
      ...
      product: {
        ...
        printedCardIncluded: { title: 'Include printed card', subtitle: '' },
        giftOptionsWrap: { title: 'Gift wrap this item', subtitle: 'Wrapping option:' },
        formContent: {
  ...
  b = ({ children: r }) => {
    var i;
    const [e, n] = c(),
      l = (i = f.getConfig()) == null ? void 0 : i.langDefinitions;
    m(() => {
      const t = u.on(
        'locale',
        a => {
    ...
    const s = d(T, l ?? {});
    return o(g, { lang: e, langDefinitions: s, children: r });
  },
  I = new p(o(b, {}));
export { I as render };
