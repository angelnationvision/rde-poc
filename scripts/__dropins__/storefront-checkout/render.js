...
(function (n, o) {
  ...
  `.checkout__banner{margin-bottom:var(--spacing-xbig)}
...
import { events as y } from '@dropins/tools/event-bus.js';
...
var v = typeof Symbol == 'function' && Symbol.for,
  P = v ? Symbol.for('react.element') : 60103;
function j(e) {
  return e.$$typeof === P;
}
function M(e) {
...
function i(e, r) {
  return r.clone !== !1 && r.isMergeableObject(e) ? o(M(e), e, r) : e;
}
function A(e, r, t) {
...
function o(e, r, t) {
  ((t = t || {}),
    (t.arrayMerge = t.arrayMerge || A),
    (t.isMergeableObject = t.isMergeableObject || S),
    (t.cloneUnlessOtherwiseSpecified = i));
  var a = Array.isArray(r),
    n = Array.isArray(e),
    s = a === n;
  return s ? (a ? t.arrayMerge(e, r, t) : x(e, r, t)) : i(r, t);
}
o.all = function (r, t) {
...
const L = O(_),
  R = {
    ...
    EmptyCart: { button: 'Start shopping', title: 'Your cart is empty' },
    EstimateShipping: {
    ...
    OutOfStock: {
      actions: { removeOutOfStock: 'Remove out of stock items', reviewCart: 'Review cart' },
      alert: 'Out of stock!',
      lowInventory: { many: 'Only {{count}} left!', one: 'Last item!' },
    ...
    ShippingMethods: {
      cartSyncError: 'We were unable to save your changes. Please try again later.',
      emptyState:
        "This order can't be shipped to the address provided. Please review the address details you entered and make sure they're correct.",
    ...
    TermsAndConditions: {
      ...
      label:
        "I have read, understand, and accept our <a href='https://www.adobe.com/legal/terms.html' target='_blank'>Terms of Use, Terms of Sales, Privacy Policy, and Return Policy</a>.",
    },
    title: 'Checkout',
  },
  U = { Checkout: R },
  ...
  k = ({ children: e }) => {
    var s;
    const [r, t] = b(),
      a = (s = g.getConfig()) == null ? void 0 : s.langDefinitions;
    h(() => {
      const c = y.on(
        'locale',
        l => {
    ...
    const n = L(B, a ?? {});
    return f(p, { lang: r, langDefinitions: n, children: e });
  },
  G = new d(f(k, {}));
export { k as Provider, G as render };
