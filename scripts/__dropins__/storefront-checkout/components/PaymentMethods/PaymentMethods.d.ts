...
export interface PaymentMethodsProps
  extends Omit<HTMLAttributes<HTMLDivElement>, 'loading' | 'title'> {
  error?: string | null;
  loading?: boolean;
  onDismissError?: () => void;
...
export declare const PaymentMethods: FunctionComponent<
  PaymentMethodsProps & import('../ConditionalWrapper/ConditionalWrapper').ConditionalProps
>;
export {};
