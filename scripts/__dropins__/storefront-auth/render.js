  ...
  try {
    if (typeof document < 'u') {
      const a = document.createElement('style'),
        n = t.styleId;
      for (const i in t.attributes) a.setAttribute(i, t.attributes[i]);
      (a.setAttribute('data-dropin', n), a.appendChild(document.createTextNode(o)));
      const r = document.querySelector('style[data-dropin="sdk"]');
      if (r) r.after(a);
      else {
        const i = document.querySelector('link[rel="stylesheet"], style');
        i ? i.before(a) : document.head.append(a);
      }
    }
  } catch (a) {
...
const w = {
    ...
    UpdatePasswordForm: { title: 'Update password', buttonPrimary: 'Update password' },
    FormText: {
    ...
    InputPassword: { placeholder: 'Password', floatingLabel: 'Password *' },
  },
  y = { Auth: w },
  b = { default: y },
  P = ({ children: n }) => {
    var a, t;
    const [e, i] = u('en_US'),
      c = (t = (a = f) == null ? void 0 : a.getConfig()) == null ? void 0 : t.langDefinitions;
    p(() => {
      const r = g.on(
        'locale',
        o => {
    ...
    const l = d(b, c ?? {});
    return s(h, { lang: e, langDefinitions: l, children: n });
  },
  A = new m(s(P, {}));
export { A as render };
