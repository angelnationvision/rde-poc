...
import { Header as ct, InLineAlert as ft, InputPassword as dt } from '@dropins/tools/components.js';
...
const gt = ({
    ...
    const [S, L] = y(''),
      ...
      [g, d] = y(''),
      [A, w] = y(!1),
      [U, j] = y({ userName: '', status: !1 }),
      [q, x] = y(!1),
      [P, N] = y([]),
      k = c(
        async r => {
          (i(), n(!0), w(!1), N([]), await et(r));
        },
        [i]
      ),
      V = c(r => {
        (r.length ? w(!1) : w(!0), d(r));
      }, []);
    J(() => {
      t != null && t.text && i({ text: t.text, type: t.status ? t.status : void 0 });
    }, [t, i]);
    const D = c(() => {
        g.length || w(!0);
      }, [g]),
      p = c((r, o) => (g.length ? !1 : (w(!0), o && st(r, g, ''), !0)), [g]),
      B = c(
        (r, o) => {
          o != null &&
            o.userName &&
      ...
      C = c(
        (r, o) => {
          var I;
          if ((I = r == null ? void 0 : r.errorMessage) != null && I.length) {
            L(o);
            const H = r.errorMessage.includes(
                "This account isn't confirmed. Verify and try again."
              ),
              T = H ? e.resendEmailInformationText : r.errorMessage;
            (N(
              H
                ? [
                    {
      ...
      W = rt(() => {
        ...
        return s != null && s.length
          ? r == null
            ? void 0
            : r.map(o => ({ ...o, defaultValue: s }))
          : r;
      }, [s]),
      X = c(() => {
        (i(), E(b) ? (window.location.href = b()) : n(!1));
      }, [i, b]);
    return {
  ...
  wt = () => {
    let t = new URL(window.location.href),
      e = t.searchParams.get('email'),
      s = t.searchParams.get('key');
    e &&
      s &&
  ...
  yt = ({ enableEmailConfirmation: t }) => {
    ...
    return (
        ...
        if (t) {
          ...
          u.includes('email=') &&
            ...
            (async () => {
              ...
              if (!a) return null;
              (f = a == null ? void 0 : a.errors) != null && f.length
      ...
      { emailConfirmationStatusMessage: s }
    );
  },
  Mt = ({
    slots: t,
    ...
    const n = lt({
      ...
      { emailConfirmationStatusMessage: g } = yt({ enableEmailConfirmation: F }),
      { inLineAlertProps: d, handleSetInLineAlertProps: A } = tt(),
      {
        userEmail: w,
    ...
    return x.status && t != null && t.SuccessNotification
      ? m(Z, {
