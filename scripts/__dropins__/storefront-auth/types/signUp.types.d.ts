...
export interface SignUpProps {
  ...
  onSuccessCallback?: (value?: { userName: string; status: boolean }) => Promise<void>;
}
...
export interface UseSingUpFormProps
  extends Omit<SignUpFormProps, 'formSize' | 'inputsDefaultValueSet' | 'slots'> {
  passwordConfigs?: {
    minLength: number;
