...
export declare const useSignInForm: ({
  ...
  setShowEmailConfirmationForm: import('preact/hooks').Dispatch<
    import('preact/hooks').StateUpdater<boolean>
  >;
  setSignInPasswordValue: import('preact/hooks').Dispatch<
    import('preact/hooks').StateUpdater<string>
  >;
