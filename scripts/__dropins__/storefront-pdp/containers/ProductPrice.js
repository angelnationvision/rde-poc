...
/* empty css             */ import { P } from '../chunks/PriceRange.js';
...
const S = ({ className: t, price: i, specialPrice: a, children: n, ...e }) => {
    const c = b('PDP.Product.RegularPrice.label').label,
      o = b('PDP.Product.SpecialPrice.label').label;
    return D('div', {
      ...e,
  ...
  N = ({ initialData: t = null, children: i, ...a }) => {
    var m, u;
    ...
    return (
      L(() => {
        const l = _.on('pdp/data', c),
          p = _.on('locale', x);
        return () => {
          (l == null || l.off(), p == null || p.off());
        };
      }, []),
      e
        ? r(S, {
            ...a,
            specialPrice:
              (m = e.prices) != null && m.visible
                ? r(P, { ...e.prices.final, locale: g(o) })
                : void 0,
            price:
              (u = e.prices) != null &&
              u.visible &&
              ...
              e.prices.final.amount !== e.prices.regular.amount
                ? r(P, { ...e.prices.regular, locale: g(o) })
                : void 0,
          })
        : null
    );
