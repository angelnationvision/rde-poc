...
const AEM_ASSETS_PRIVATE_USER = JSON.parse(process.env.AEM_ASSETS_PRIVATE_USER ?? '{}');
...
module.exports = defineConfig({
  ...
  env: {
    ...
    aemAssetsConfig: {
      commerceConfig: {
        coreEndpoint:
          'https://edge-sandbox-graph.adobe.io/api/a6ff161c-9ccf-4c31-a220-be236213ed0f/graphql',
        endpoint:
          'https://edge-sandbox-graph.adobe.io/api/a6ff161c-9ccf-4c31-a220-be236213ed0f/graphql',
      },
